<template>
  <el-scrollbar style="background-color: #ffffff;">


    <el-menu style="" :default-openeds="['1', '3','4','5'] ">
        ...
        <el-menu-item-group>
          <el-sub-menu index=3-1>
            ...
            <el-menu-item-group>
              ...
              <el-menu-item @click="$router.push('/budget/manager')" index="3-1-2">在途申请</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          ...
          <el-sub-menu index="3-3">
            ...
            <el-menu-item-group>
              <el-menu-item @click="$router.push('/budget/budgetAudit/myaudit')" index="3-3-1">个人申请查询</el-menu-item>
              <el-menu-item @click="$router.push('/budget/budgetAudit/myaudit')" index="3-3-2">部门申请查询</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
      ...
      <el-sub-menu index=4>
        ...
        <el-menu-item-group>
          <el-menu-item @click="$router.push('/unit/manager')" index=4-1>
      ...
      <el-sub-menu index=5>
        ...
        <el-menu-item-group>
          <el-sub-menu index=5-1>
            ...
            <el-menu-item-group>
              <el-menu-item index="5-1-1">数据备份</el-menu-item>
              <el-menu-item index="5-1-2">数据清空</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-sub-menu index=5-2>
            <template #title>系统初始化</template>
            <el-menu-item-group>
              <el-menu-item index="5-2-1">学校信息</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>

          <el-menu-item @click="$router.push('/flow/design')" index="5-3">流程设置</el-menu-item>
...
<!--          </el-sub-menu>-->
          <el-sub-menu index=5-4>
            <template #title>字典数据维护</template>
            <el-menu-item-group>
              <el-menu-item index="5-4-1">预算类型</el-menu-item>
              <el-menu-item index="5-4-2">其他字典</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-menu-item @click="$router.push('/file')" index="5-5">附件管理</el-menu-item>
        </el-menu-item-group>
      </el-sub-menu>
